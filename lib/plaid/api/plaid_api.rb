...
module Plaid
  class PlaidApi
    ...
    # The `/transfer/repayment/list` endpoint fetches repayments matching the given filters. Repayments are returned in chronological order (least recent first) starting at the given `start_time`.
    ...
    # Retrieves the set of returns that were batched together into the specified repayment. The sum of amounts of returns retrieved by this request equals the amount of the repayment.
