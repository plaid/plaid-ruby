...
module Plaid
  ...
  class BaseReportAccount
    ...
    def hash
      [account_id, balances, consumer_disputes, mask, name, official_name, type, subtype, days_available, transactions, owners, ownership_type, historical_balances, account_insights, attributes].hash
    end
