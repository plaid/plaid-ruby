...
module Plaid
  ...
  class Cause
    ...
    attr_accessor :error_code_reason
    ...
    attr_accessor :required_account_subtypes

    # A list of the account subtypes that were extracted but did not match the requested subtypes via the `account_filters`  parameter in `/link/token/create`. Currently only populated for `NO_ACCOUNTS` errors from Items with `investments_auth` as an enabled product. 
    attr_accessor :provided_account_subtypes
    ...
    def self.attribute_map
      {
        ...
        :'required_account_subtypes' => :'required_account_subtypes',
        :'provided_account_subtypes' => :'provided_account_subtypes',
        :'item_id' => :'item_id'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'required_account_subtypes')
        if (value = attributes[:'required_account_subtypes']).is_a?(Array)
          self.required_account_subtypes = value
        end
      end

      if attributes.key?(:'provided_account_subtypes')
        if (value = attributes[:'provided_account_subtypes']).is_a?(Array)
          self.provided_account_subtypes = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          required_account_subtypes == o.required_account_subtypes &&
    ...
    def hash
      [error_type, error_code, error_code_reason, error_message, display_message, request_id, causes, status, documentation_url, suggested_action, required_account_subtypes, provided_account_subtypes, item_id].hash
    end
