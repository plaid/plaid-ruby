...
module Plaid
  ...
  class BeaconReportUpdatedWebhook
    ...
    attr_accessor :beacon_report_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::BeaconReportUpdatedWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::BeaconReportUpdatedWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'beacon_report_id')
        self.beacon_report_id = attributes[:'beacon_report_id']
      end
    ...
    def list_invalid_properties
      ...
      if @beacon_report_id.nil?
        invalid_properties.push('invalid value for "beacon_report_id", beacon_report_id cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          beacon_report_id == o.beacon_report_id &&
    ...
    def hash
      [webhook_type, webhook_code, beacon_report_id, environment].hash
    end
