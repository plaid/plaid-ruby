...
module Plaid
  ...
  class EntityScreeningStatusUpdatedWebhook
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'screening_id')
        self.screening_id = attributes[:'screening_id']
      end
    ...
    def list_invalid_properties
      ...
      if @screening_id.nil?
        invalid_properties.push('invalid value for "screening_id", screening_id cannot be nil.')
      end
    ...
    def hash
      [webhook_type, webhook_code, screening_id, environment].hash
    end
