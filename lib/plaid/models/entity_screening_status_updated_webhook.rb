...
module Plaid
  ...
  class EntityScreeningStatusUpdatedWebhook
    ...
    attr_accessor :entity_screening_id
    ...
    def self.attribute_map
      {
        ...
        :'entity_screening_id' => :'entity_screening_id',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::EntityScreeningStatusUpdatedWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::EntityScreeningStatusUpdatedWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'entity_screening_id')
        self.entity_screening_id = attributes[:'entity_screening_id']
      end
    ...
    def list_invalid_properties
      ...
      if @entity_screening_id.nil?
        invalid_properties.push('invalid value for "entity_screening_id", entity_screening_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @entity_screening_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          entity_screening_id == o.entity_screening_id &&
    ...
    def hash
      [webhook_type, webhook_code, entity_screening_id, environment].hash
    end
