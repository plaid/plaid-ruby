...
module Plaid
  # Fired when the risk signal computation for all uploaded documents in an income verification is completed. It will typically take several minutes for this webhook to fire after the end user has uploaded their documents in the Document Income flow.
  class IncomeVerificationRiskSignalsStatusWebhook
    ...
    attr_accessor :risk_signals_status
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::IncomeVerificationRiskSignalsStatusWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::IncomeVerificationRiskSignalsStatusWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'risk_signals_status')
        self.risk_signals_status = attributes[:'risk_signals_status']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item_id == o.item_id &&
          user_id == o.user_id &&
          risk_signals_status == o.risk_signals_status &&
    ...
    def hash
      [webhook_type, webhook_code, item_id, user_id, risk_signals_status, environment].hash
    end
