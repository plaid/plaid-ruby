...
module Plaid
  ...
  class TCHNotification
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'token_timestamp')
        self.token_timestamp = attributes[:'token_timestamp']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          token_timestamp == o.token_timestamp
    end
    ...
    def hash
      [message_id, conversation_id, token_requestor_id, token_reference_id, token_timestamp].hash
    end
