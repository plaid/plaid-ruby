  ...
  class DepositSwitchTargetAccount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::DepositSwitchTargetAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::DepositSwitchTargetAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      account_subtype_validator = EnumAttributeValidator.new('String', ["checking", "savings"])
      return false unless account_subtype_validator.valid?(@account_subtype)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] account_subtype Object to be assigned
    def account_subtype=(account_subtype)
      validator = EnumAttributeValidator.new('String', ["checking", "savings"])
      unless validator.valid?(account_subtype)
        fail ArgumentError, "invalid value for \"account_subtype\", must be one of #{validator.allowable_values}."
      end
      @account_subtype = account_subtype
    end
    ...
    def hash
      [account_number, routing_number, account_name, account_subtype].hash
    end
