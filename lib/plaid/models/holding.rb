...
module Plaid
  ...
  class Holding
    ...
    def hash
      [account_id, security_id, institution_price, institution_price_as_of, institution_price_datetime, institution_value, cost_basis, quantity, iso_currency_code, unofficial_currency_code].hash
    end
