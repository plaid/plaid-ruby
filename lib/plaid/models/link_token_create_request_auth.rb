...
module Plaid
  ...
  class LinkTokenCreateRequestAuth
    ...
    def hash
      [auth_type_select_enabled, automated_microdeposits_enabled, instant_match_enabled, same_day_microdeposits_enabled, instant_microdeposits_enabled, reroute_to_credentials, flow_type].hash
    end
