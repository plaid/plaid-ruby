...
module Plaid
  ...
  class PayPeriodDetails
    ...
    attr_accessor :distribution_breakdown
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::PayPeriodDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::PayPeriodDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'distribution_breakdown')
        if (value = attributes[:'distribution_breakdown']).is_a?(Array)
          self.distribution_breakdown = value
        end
      end
    ...
    def valid?
      pay_frequency_validator = EnumAttributeValidator.new('String', ["PAY_FREQUENCY_UNKNOWN", "PAY_FREQUENCY_WEEKLY", "PAY_FREQUENCY_BIWEEKLY", "PAY_FREQUENCY_SEMIMONTHLY", "PAY_FREQUENCY_MONTHLY", "null"])
    ...
    def pay_frequency=(pay_frequency)
      validator = EnumAttributeValidator.new('String', ["PAY_FREQUENCY_UNKNOWN", "PAY_FREQUENCY_WEEKLY", "PAY_FREQUENCY_BIWEEKLY", "PAY_FREQUENCY_SEMIMONTHLY", "PAY_FREQUENCY_MONTHLY", "null"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          distribution_breakdown == o.distribution_breakdown &&
          end_date == o.end_date &&
    ...
    def hash
      [check_amount, distribution_breakdown, end_date, gross_earnings, pay_date, pay_frequency, pay_day, start_date].hash
    end
