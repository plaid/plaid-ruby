...
module Plaid
  ...
  class TransactionStream
    ...
    def hash
      [account_id, stream_id, category, category_id, description, merchant_name, first_date, last_date, frequency, transaction_ids, average_amount, last_amount, is_active, status, personal_finance_category].hash
    end
