...
module Plaid
  ...
  class IdentityVerificationCreateResponse
    ...
    attr_accessor :latest_scored_protect_event
    ...
    def self.attribute_map
      {
        ...
        :'latest_scored_protect_event' => :'latest_scored_protect_event',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'latest_scored_protect_event')
        self.latest_scored_protect_event = attributes[:'latest_scored_protect_event']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          latest_scored_protect_event == o.latest_scored_protect_event &&
    ...
    def hash
      [id, client_user_id, created_at, completed_at, previous_attempt_id, shareable_url, template, user, status, steps, documentary_verification, selfie_check, kyc_check, risk_check, verify_sms, watchlist_screening_id, beacon_user_id, user_id, redacted_at, latest_scored_protect_event, request_id].hash
    end
