...
module Plaid
  ...
  class BusinessVerificationCreateResponse
    ...
    attr_accessor :kyb_check

    attr_accessor :risk_check

    attr_accessor :digital_presence_check
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::BusinessVerificationCreateResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::BusinessVerificationCreateResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'kyb_check')
        self.kyb_check = attributes[:'kyb_check']
      end
      ...
      if attributes.key?(:'digital_presence_check')
        self.digital_presence_check = attributes[:'digital_presence_check']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          kyb_check == o.kyb_check &&
          risk_check == o.risk_check &&
          digital_presence_check == o.digital_presence_check &&
    ...
    def hash
      [id, client_user_id, created_at, completed_at, redacted_at, status, search_terms, kyb_check, risk_check, digital_presence_check, request_id, shareable_url].hash
    end
