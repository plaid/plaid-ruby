...
module Plaid
  ...
  class PlaidError
    ...
    def hash
      [error_type, error_code, error_code_reason, error_message, display_message, request_id, causes, status, documentation_url, suggested_action, required_account_subtypes, provided_account_subtypes].hash
    end
