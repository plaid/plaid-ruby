...
module Plaid
  ...
  class TransferCreateRequest
    ...
    def hash
      [client_id, secret, idempotency_key, access_token, account_id, authorization_id, type, network, amount, iso_currency_code, description, ach_class, user, custom_tag, metadata, origination_account_id].hash
    end
