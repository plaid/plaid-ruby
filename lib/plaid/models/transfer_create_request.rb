...
module Plaid
  ...
  class TransferCreateRequest
    ...
    def hash
      [client_id, secret, idempotency_key, access_token, account_id, authorization_id, type, network, amount, description, ach_class, user, metadata, origination_account_id, iso_currency_code, test_clock_id, facilitator_fee].hash
    end
