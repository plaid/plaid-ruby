...
module Plaid
  ...
  class AccountIdentityMatchScore
    ...
    def hash
      [account_id, balances, mask, name, official_name, type, subtype, verification_status, verification_insights, persistent_account_id, legal_name, phone_number, email_address, address].hash
    end
