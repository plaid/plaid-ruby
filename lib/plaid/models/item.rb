...
module Plaid
  ...
  class Item
    ...
    def hash
      [item_id, institution_id, created_at, webhook, error, available_products, billed_products, products, consented_products, consented_use_cases, consented_data_scopes, consent_expiration_time, update_type].hash
    end
