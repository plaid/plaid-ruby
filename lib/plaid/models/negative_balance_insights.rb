...
module Plaid
  ...
  class NegativeBalanceInsights
    ...
    attr_accessor :days_with_negative_balance
    ...
    def self.openapi_types
      {
        ...
        :'occurrences' => :'Array<NegativeBalanceOccurrence>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::NegativeBalanceInsights` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::NegativeBalanceInsights`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'days_with_negative_balance')
        self.days_with_negative_balance = attributes[:'days_with_negative_balance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          days_with_negative_balance == o.days_with_negative_balance &&
    ...
    def hash
      [days_since_last_occurrence, days_with_negative_balance, minimum_balance, occurrences].hash
    end
