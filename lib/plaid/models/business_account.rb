...
module Plaid
  ...
  class BusinessAccount
    ...
    def hash
      [account_id, balances, mask, name, official_name, type, subtype, verification_status, verification_name, verification_insights, persistent_account_id, holder_category, owners, historical_balances].hash
    end
