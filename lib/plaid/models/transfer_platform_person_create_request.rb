...
module Plaid
  ...
  class TransferPlatformPersonCreateRequest
    ...
    attr_accessor :relationship_to_originator
    ...
    def ownership_percentage=(ownership_percentage)
      if !ownership_percentage.nil? && ownership_percentage > 100
        fail ArgumentError, 'invalid value for "ownership_percentage", must be smaller than or equal to 100.'
      end

      if !ownership_percentage.nil? && ownership_percentage < 25
        fail ArgumentError, 'invalid value for "ownership_percentage", must be greater than or equal to 25.'
      end
    ...
    def hash
      [client_id, secret, originator_client_id, name, email_address, phone_number, address, id_number, date_of_birth, relationship_to_originator, ownership_percentage, title].hash
    end
