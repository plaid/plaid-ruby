...
module Plaid
  ...
  class NameMatchScore
    ...
    attr_accessor :is_first_name_or_last_name_match

    # nickname matched, example Jennifer and Jenn.
    attr_accessor :is_nickname_match
    ...
    attr_accessor :is_business_name_detected
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::NameMatchScore` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::NameMatchScore`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_first_name_or_last_name_match')
        self.is_first_name_or_last_name_match = attributes[:'is_first_name_or_last_name_match']
      end

      if attributes.key?(:'is_nickname_match')
        self.is_nickname_match = attributes[:'is_nickname_match']
      end

      if attributes.key?(:'is_business_name_detected')
        self.is_business_name_detected = attributes[:'is_business_name_detected']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          score == o.score &&
          is_first_name_or_last_name_match == o.is_first_name_or_last_name_match &&
          is_nickname_match == o.is_nickname_match &&
          is_business_name_detected == o.is_business_name_detected
    end
    ...
    def hash
      [score, is_first_name_or_last_name_match, is_nickname_match, is_business_name_detected].hash
    end
