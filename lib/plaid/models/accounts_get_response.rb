...
module Plaid
  ...
  class AccountsGetResponse
    ...
    attr_accessor :payment_risk_assessment
    ...
    def self.attribute_map
      {
        :'accounts' => :'accounts',
        :'item' => :'item',
        :'payment_risk_assessment' => :'payment_risk_assessment',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::AccountsGetResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::AccountsGetResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_risk_assessment')
        self.payment_risk_assessment = attributes[:'payment_risk_assessment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounts == o.accounts &&
          item == o.item &&
          payment_risk_assessment == o.payment_risk_assessment &&
    ...
    def hash
      [accounts, item, payment_risk_assessment, request_id].hash
    end
