...
module Plaid
  ...
  class WalletTransactionGetResponse
    ...
    def hash
      [transaction_id, wallet_id, reference, type, scheme, amount, counterparty, status, created_at, last_status_update, payment_id, failure_reason, error, related_transactions, request_id].hash
    end
