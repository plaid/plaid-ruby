...
module Plaid
  ...
  class SignalEvaluateRequest
    ...
    def list_invalid_properties
      ...
      if !@risk_profile_key.nil? && @risk_profile_key.to_s.length > 32
        invalid_properties.push('invalid value for "risk_profile_key", the character length must be smaller than or equal to 32.')
      end
    ...
    def valid?
      ...
      return false if !@risk_profile_key.nil? && @risk_profile_key.to_s.length > 32
    ...
    def risk_profile_key=(risk_profile_key)
      if !risk_profile_key.nil? && risk_profile_key.to_s.length > 32
        fail ArgumentError, 'invalid value for "risk_profile_key", the character length must be smaller than or equal to 32.'
      end
    ...
    def hash
      [client_id, secret, access_token, account_id, client_transaction_id, amount, user_present, client_user_id, is_recurring, default_payment_method, user, device, risk_profile_key].hash
    end
