...
module Plaid
  ...
  class TransferAuthorizationProposedTransfer
    ...
    def hash
      [ach_class, account_id, funding_account_id, type, user, amount, network, origination_account_id, iso_currency_code, originator_client_id, credit_funds_source].hash
    end
