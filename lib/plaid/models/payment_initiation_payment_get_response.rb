...
module Plaid
  ...
  class PaymentInitiationPaymentGetResponse
    ...
    attr_accessor :initiated_refunds
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'initiated_refunds')
        if (value = attributes[:'initiated_refunds']).is_a?(Array)
          self.initiated_refunds = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bacs == o.bacs &&
          iban == o.iban &&
          initiated_refunds == o.initiated_refunds &&
    ...
    def hash
      [payment_id, amount, status, recipient_id, reference, adjusted_reference, last_status_update, schedule, refund_details, bacs, iban, initiated_refunds, wallet_id, scheme, adjusted_scheme, consent_id, request_id].hash
    end
