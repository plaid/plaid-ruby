...
module Plaid
  ...
  class PaymentInitiationPaymentGetResponse
    ...
    def hash
      [payment_id, amount, status, recipient_id, reference, adjusted_reference, last_status_update, schedule, refund_details, bacs, iban, initiated_refunds, wallet_id, request_id].hash
    end
