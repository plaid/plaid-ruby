...
module Plaid
  ...
  class CreditBankEmploymentItem
    ...
    attr_accessor :bank_employments

    # The Item's accounts that have Bank Employment data.
    attr_accessor :bank_employment_accounts
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::CreditBankEmploymentItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::CreditBankEmploymentItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bank_employments')
        if (value = attributes[:'bank_employments']).is_a?(Array)
          self.bank_employments = value
        end
      end

      if attributes.key?(:'bank_employment_accounts')
        if (value = attributes[:'bank_employment_accounts']).is_a?(Array)
          self.bank_employment_accounts = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bank_employments.nil?
        invalid_properties.push('invalid value for "bank_employments", bank_employments cannot be nil.')
      end

      if @bank_employment_accounts.nil?
        invalid_properties.push('invalid value for "bank_employment_accounts", bank_employment_accounts cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bank_employments == o.bank_employments &&
          bank_employment_accounts == o.bank_employment_accounts
    end
    ...
    def hash
      [item_id, last_updated_time, institution_id, institution_name, bank_employments, bank_employment_accounts].hash
    end
