...
module Plaid
  ...
  class ProcessorInvestmentsTransactionsGetResponse
    ...
    def hash
      [account, investment_transactions, securities, total_investment_transactions, request_id, is_investments_fallback_item].hash
    end
