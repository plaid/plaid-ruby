...
module Plaid
  ...
  class ClientProvidedEnrichedTransaction
    ...
    attr_accessor :client_customization
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'client_customization')
        self.client_customization = attributes[:'client_customization']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          client_customization == o.client_customization
    end
    ...
    def hash
      [id, client_user_id, client_account_id, account_type, account_subtype, description, amount, direction, iso_currency_code, enrichments, client_customization].hash
    end
