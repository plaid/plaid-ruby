...
module Plaid
  ...
  class LinkTokenCreateRequest
    ...
    def hash
      [client_id, secret, client_name, language, country_codes, user, products, additional_consented_products, webhook, access_token, link_customization_name, redirect_uri, android_package_name, institution_data, account_filters, eu_config, institution_id, payment_initiation, deposit_switch, employment, income_verification, auth, transfer, update, identity_verification, user_token, investments].hash
    end
