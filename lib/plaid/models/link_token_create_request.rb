...
module Plaid
  ...
  class LinkTokenCreateRequest
    ...
    # Brown bag demo
    attr_accessor :testing_brown_bag
    ...
    def self.attribute_map
      {
        ...
        :'auth' => :'auth',
        :'testing_brown_bag' => :'testing_brown_bag'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'testing_brown_bag')
        self.testing_brown_bag = attributes[:'testing_brown_bag']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auth == o.auth &&
          testing_brown_bag == o.testing_brown_bag
    end
    ...
    def hash
      [client_id, secret, client_name, language, country_codes, user, products, webhook, access_token, link_customization_name, redirect_uri, android_package_name, account_filters, institution_id, payment_initiation, deposit_switch, income_verification, auth, testing_brown_bag].hash
    end
