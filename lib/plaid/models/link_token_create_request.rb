...
module Plaid
  ...
  class LinkTokenCreateRequest
    ...
    def hash
      [client_id, secret, client_name, language, country_codes, user, products, required_if_supported_products, optional_products, additional_consented_products, webhook, access_token, access_tokens, link_customization_name, appearance_mode, redirect_uri, android_package_name, institution_data, card_switch, account_filters, eu_config, institution_id, payment_configuration, payment_initiation, deposit_switch, employment, income_verification, base_report, credit_partner_insights, cra_options, consumer_report_permissible_purpose, auth, transfer, update, identity_verification, statements, user_token, third_party_user_token, investments, investments_auth, hosted_link, transactions, cashflow_report, cra_enabled, identity, financekit_supported, enable_multi_item_link].hash
    end
