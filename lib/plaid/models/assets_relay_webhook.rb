  ...
  class AssetsRelayWebhook
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::AssetsRelayWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::AssetsRelayWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'relay_event')
        self.relay_event = attributes[:'relay_event']
      end

      if attributes.key?(:'secondary_client_id')
        self.secondary_client_id = attributes[:'secondary_client_id']
      end

      if attributes.key?(:'asset_relay_token')
        self.asset_relay_token = attributes[:'asset_relay_token']
      end
    ...
    def list_invalid_properties
      ...
      if @relay_event.nil?
        invalid_properties.push('invalid value for "relay_event", relay_event cannot be nil.')
      end

      if @secondary_client_id.nil?
        invalid_properties.push('invalid value for "secondary_client_id", secondary_client_id cannot be nil.')
      end

      if @asset_relay_token.nil?
        invalid_properties.push('invalid value for "asset_relay_token", asset_relay_token cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @relay_event.nil?
      return false if @secondary_client_id.nil?
      return false if @asset_relay_token.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          relay_event == o.relay_event &&
          secondary_client_id == o.secondary_client_id &&
          asset_relay_token == o.asset_relay_token &&
    ...
    def hash
      [webhook_type, webhook_code, relay_event, secondary_client_id, asset_relay_token, asset_report_id].hash
    end
