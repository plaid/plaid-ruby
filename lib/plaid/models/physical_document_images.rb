  ...
  class PhysicalDocumentImages
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::PhysicalDocumentImages` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::PhysicalDocumentImages`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'original_front')
        self.original_front = attributes[:'original_front']
      end

      if attributes.key?(:'original_back')
        self.original_back = attributes[:'original_back']
      end

      if attributes.key?(:'cropped_front')
        self.cropped_front = attributes[:'cropped_front']
      end

      if attributes.key?(:'cropped_back')
        self.cropped_back = attributes[:'cropped_back']
      end

      if attributes.key?(:'face')
    ...
    def list_invalid_properties
      ...
      if @original_front.nil?
        invalid_properties.push('invalid value for "original_front", original_front cannot be nil.')
      end
    ...
    def valid?
      return false if @original_front.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          original_front == o.original_front &&
          original_back == o.original_back &&
          cropped_front == o.cropped_front &&
          cropped_back == o.cropped_back &&
          face == o.face
    end
    ...
    def hash
      [original_front, original_back, cropped_front, cropped_back, face].hash
    end
