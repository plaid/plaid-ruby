...
module Plaid
  class TransactionAllOf
    ...
    def hash
      [payment_channel, authorized_date, authorized_datetime, datetime, transaction_code, personal_finance_category, personal_finance_category_icon_url, counterparties].hash
    end
