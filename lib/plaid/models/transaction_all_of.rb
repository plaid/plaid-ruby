...
module Plaid
  class TransactionAllOf
    ...
    def hash
      [authorized_date, authorized_datetime, datetime, payment_channel, personal_finance_category, business_finance_category, transaction_code, personal_finance_category_icon_url, counterparties, merchant_entity_id, client_customization].hash
    end
