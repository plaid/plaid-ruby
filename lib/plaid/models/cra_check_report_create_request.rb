...
module Plaid
  ...
  class CraCheckReportCreateRequest
    ...
    # Specifies a list of products that will be eagerly generated when creating the report. These products will be made available before a success webhook is sent. Use this option if you know which products you want in the report up-front, in order to optimize latency. The `cra_base_report` product will always be generated and needs not be specified here.
    ...
    def self.openapi_types
      {
        ...
        :'partner_insights' => :'CraCheckReportPartnerInsightsGetOptions',
    ...
    def hash
      [client_id, secret, user_token, webhook, days_requested, days_required, products, base_report, cashflow_insights, partner_insights, consumer_report_permissible_purpose].hash
    end
