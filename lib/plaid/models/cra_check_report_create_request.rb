...
module Plaid
  ...
  class CraCheckReportCreateRequest
    ...
    def hash
      [client_id, secret, user_id, user_token, webhook, days_requested, days_required, client_report_id, products, base_report, cashflow_insights, partner_insights, lend_score, network_insights, include_investments, income_insights, consumer_report_permissible_purpose].hash
    end
