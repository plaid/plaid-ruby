  ...
  class DisbursementLimits
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::DisbursementLimits` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::DisbursementLimits`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @maximum_amount.nil?
        invalid_properties.push('invalid value for "maximum_amount", maximum_amount cannot be nil.')
      end

      if @monthly_amount.nil?
        invalid_properties.push('invalid value for "monthly_amount", monthly_amount cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @maximum_amount.nil?
      return false if @monthly_amount.nil?
      true
    end
    ...
    def hash
      [average_amount, maximum_amount, monthly_amount].hash
    end
