...
module Plaid
  ...
  class TransferRecurringCreateRequest
    ...
    def hash
      [client_id, secret, access_token, idempotency_key, account_id, type, network, ach_class, amount, user_present, iso_currency_code, test_clock_id, schedule, user, device].hash
    end
