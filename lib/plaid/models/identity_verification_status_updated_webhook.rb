...
module Plaid
  ...
  class IdentityVerificationStatusUpdatedWebhook
    ...
    attr_accessor :identity_verification_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::IdentityVerificationStatusUpdatedWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::IdentityVerificationStatusUpdatedWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'identity_verification_id')
        self.identity_verification_id = attributes[:'identity_verification_id']
      end
    ...
    def list_invalid_properties
      ...
      if @identity_verification_id.nil?
        invalid_properties.push('invalid value for "identity_verification_id", identity_verification_id cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          identity_verification_id == o.identity_verification_id &&
    ...
    def hash
      [webhook_type, webhook_code, identity_verification_id, environment].hash
    end
