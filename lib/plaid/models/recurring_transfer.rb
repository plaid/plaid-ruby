...
module Plaid
  ...
  class RecurringTransfer
    ...
    def hash
      [recurring_transfer_id, created, next_origination_date, test_clock_id, type, amount, status, ach_class, network, origination_account_id, account_id, iso_currency_code, description, transfer_ids, user, schedule].hash
    end
