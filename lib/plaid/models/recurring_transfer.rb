...
module Plaid
  ...
  class RecurringTransfer
    ...
    def list_invalid_properties
      ...
      if @next_origination_date.nil?
        invalid_properties.push('invalid value for "next_origination_date", next_origination_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @next_origination_date.nil?
    ...
    def hash
      [recurring_transfer_id, created, next_origination_date, test_clock_id, type, amount, status, ach_class, network, origination_account_id, account_id, iso_currency_code, transfer_ids, decision, decision_rationale, user, schedule].hash
    end
