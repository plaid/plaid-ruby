...
module Plaid
  ...
  class TransferConfigurationGetResponse
    ...
    attr_accessor :max_daily_credit_amount
    ...
    attr_accessor :max_daily_debit_amount
    ...
    attr_accessor :max_monthly_credit_amount
    ...
    attr_accessor :max_monthly_debit_amount
