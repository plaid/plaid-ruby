...
module Plaid
  ...
  class TransferEventListRequest
    ...
    def hash
      [client_id, secret, start_date, end_date, transfer_id, account_id, transfer_type, event_types, sweep_id, count, offset, origination_account_id, originator_client_id, funding_account_id].hash
    end
