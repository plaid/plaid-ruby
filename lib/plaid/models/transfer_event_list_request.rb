...
module Plaid
  ...
  class TransferEventListRequest
    ...
    def valid?
      transfer_type_validator = EnumAttributeValidator.new('String', ["debit", "credit", "null"])
    ...
    def hash
      [client_id, secret, start_date, end_date, transfer_id, account_id, transfer_type, event_types, count, offset, origination_account_id, direction].hash
    end
