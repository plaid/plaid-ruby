...
module Plaid
  ...
  class SMSVerification
    ...
    attr_accessor :delivery_attempt_count
    ...
    attr_accessor :solve_attempt_count

    # An ISO8601 formatted timestamp.
    attr_accessor :initially_sent_at
    ...
    def self.openapi_types
      {
        ...
        :'solve_attempt_count' => :'Integer',
        :'initially_sent_at' => :'Time',
        :'last_sent_at' => :'Time',
        :'redacted_at' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::SMSVerification` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::SMSVerification`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'delivery_attempt_count')
        self.delivery_attempt_count = attributes[:'delivery_attempt_count']
      end

      if attributes.key?(:'solve_attempt_count')
        self.solve_attempt_count = attributes[:'solve_attempt_count']
      end

      if attributes.key?(:'initially_sent_at')
        self.initially_sent_at = attributes[:'initially_sent_at']
      end
    ...
    def list_invalid_properties
      ...
      if @delivery_attempt_count.nil?
        invalid_properties.push('invalid value for "delivery_attempt_count", delivery_attempt_count cannot be nil.')
      end

      if @solve_attempt_count.nil?
        invalid_properties.push('invalid value for "solve_attempt_count", solve_attempt_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @delivery_attempt_count.nil?
      return false if @solve_attempt_count.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          solve_attempt_count == o.solve_attempt_count &&
          initially_sent_at == o.initially_sent_at &&
    ...
    def hash
      [status, attempt, phone_number, delivery_attempt_count, solve_attempt_count, initially_sent_at, last_sent_at, redacted_at].hash
    end
