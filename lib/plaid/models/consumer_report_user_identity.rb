...
module Plaid
  ...
  class ConsumerReportUserIdentity
    ...
    def ssn_last_4=(ssn_last_4)
      if !ssn_last_4.nil? && ssn_last_4.to_s.length > 4
        fail ArgumentError, 'invalid value for "ssn_last_4", the character length must be smaller than or equal to 4.'
      end

      if !ssn_last_4.nil? && ssn_last_4.to_s.length < 4
        fail ArgumentError, 'invalid value for "ssn_last_4", the character length must be great than or equal to 4.'
      end
    ...
    def hash
      [first_name, last_name, phone_numbers, emails, ssn_last_4, date_of_birth, primary_address].hash
    end
