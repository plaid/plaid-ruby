...
module Plaid
  ...
  class BeaconDuplicateDetectedWebhook
    ...
    attr_accessor :beacon_duplicate_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::BeaconDuplicateDetectedWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::BeaconDuplicateDetectedWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'beacon_duplicate_id')
        self.beacon_duplicate_id = attributes[:'beacon_duplicate_id']
      end
    ...
    def list_invalid_properties
      ...
      if @beacon_duplicate_id.nil?
        invalid_properties.push('invalid value for "beacon_duplicate_id", beacon_duplicate_id cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          beacon_duplicate_id == o.beacon_duplicate_id &&
    ...
    def hash
      [webhook_type, webhook_code, beacon_duplicate_id, environment].hash
    end
