...
module Plaid
  ...
  class TransferEvent
    ...
    def hash
      [event_id, timestamp, event_type, account_id, funding_account_id, ledger_id, transfer_id, origination_account_id, transfer_type, transfer_amount, failure_reason, sweep_id, sweep_amount, refund_id, originator_client_id].hash
    end
