...
module Plaid
  ...
  class ExternalPaymentOptions
    ...
    attr_accessor :scheme_automatic_downgrade
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::ExternalPaymentOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::ExternalPaymentOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'request_refund_details')
        self.request_refund_details = attributes[:'request_refund_details']
      end
      ...
      if attributes.key?(:'scheme_automatic_downgrade')
        self.scheme_automatic_downgrade = attributes[:'scheme_automatic_downgrade']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@wallet_id.nil? && @wallet_id.to_s.length < 1
    ...
    def valid?
      ...
      return false if !@wallet_id.nil? && @wallet_id.to_s.length < 1
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scheme == o.scheme &&
          scheme_automatic_downgrade == o.scheme_automatic_downgrade
    end
    ...
    def hash
      [request_refund_details, iban, bacs, wallet_id, scheme, scheme_automatic_downgrade].hash
    end
