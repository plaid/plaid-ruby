...
module Plaid
  ...
  class OverrideAccounts
    ...
    def hash
      [type, subtype, starting_balance, force_available_balance, currency, meta, numbers, transactions, holdings, investment_transactions, identity, liability, inflow_model].hash
    end
