...
module Plaid
  ...
  class CraVoaReportAccount
    ...
    attr_accessor :transactions_insights
    ...
    def hash
      [account_id, balances, consumer_disputes, mask, name, official_name, type, subtype, days_available, transactions_insights, owners, ownership_type, investments].hash
    end
