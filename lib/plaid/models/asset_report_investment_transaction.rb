...
module Plaid
  ...
  class AssetReportInvestmentTransaction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::AssetReportInvestmentTransaction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::AssetReportInvestmentTransaction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @vested_quantity.nil?
        invalid_properties.push('invalid value for "vested_quantity", vested_quantity cannot be nil.')
      end

      if @vested_value.nil?
        invalid_properties.push('invalid value for "vested_value", vested_value cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @vested_quantity.nil?
      return false if @vested_value.nil?
    ...
    def hash
      [investment_transaction_id, account_id, security_id, date, name, quantity, vested_quantity, vested_value, amount, price, fees, type, subtype, iso_currency_code, unofficial_currency_code].hash
    end
