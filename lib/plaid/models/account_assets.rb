...
module Plaid
  ...
  class AccountAssets
    ...
    def valid?
      ...
      verification_status_validator = EnumAttributeValidator.new('String', ["automatically_verified", "pending_automatic_verification", "pending_manual_verification", "manually_verified", "verification_expired", "verification_failed", "database_matched"])
    ...
    def verification_status=(verification_status)
      validator = EnumAttributeValidator.new('String', ["automatically_verified", "pending_automatic_verification", "pending_manual_verification", "manually_verified", "verification_expired", "verification_failed", "database_matched"])
    ...
    def hash
      [account_id, balances, mask, name, official_name, type, subtype, verification_status, persistent_account_id, holder_category, days_available, transactions, investments, owners, ownership_type, historical_balances].hash
    end
