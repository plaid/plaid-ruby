...
module Plaid
  ...
  class AccountAssets
    ...
    def hash
      [account_id, balances, mask, name, official_name, type, subtype, verification_status, persistent_account_id, days_available, transactions, owners, ownership_type, historical_balances].hash
    end
