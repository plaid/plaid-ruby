...
module Plaid
  ...
  class AuthDefaultUpdateWebhook
    # `AUTH`
    ...
    attr_accessor :account_ids_with_new_auth
    ...
    attr_accessor :account_ids_with_updated_auth
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item_id == o.item_id &&
          account_ids_with_new_auth == o.account_ids_with_new_auth &&
          account_ids_with_updated_auth == o.account_ids_with_updated_auth &&
          error == o.error &&
    ...
    def hash
      [webhook_type, webhook_code, item_id, account_ids_with_new_auth, account_ids_with_updated_auth, error, environment].hash
    end
