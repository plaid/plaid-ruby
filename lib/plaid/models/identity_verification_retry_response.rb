...
module Plaid
  ...
  class IdentityVerificationRetryResponse
    ...
    def hash
      [id, client_user_id, created_at, completed_at, previous_attempt_id, shareable_url, template, user, status, steps, documentary_verification, kyc_check, risk_check, watchlist_screening_id, redacted_at, request_id].hash
    end
