...
module Plaid
  ...
  class CraUserCheckReportReadyWebhook
    # `CHECK_REPORT`
    ...
    attr_accessor :successful_products
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::CraUserCheckReportReadyWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::CraUserCheckReportReadyWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'successful_products')
        if (value = attributes[:'successful_products']).is_a?(Array)
          self.successful_products = value
        end
      end

      if attributes.key?(:'failed_products')
        if (value = attributes[:'failed_products']).is_a?(Array)
          self.failed_products = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_id == o.user_id &&
          successful_products == o.successful_products &&
          failed_products == o.failed_products &&
          item_ids == o.item_ids &&
    ...
    def hash
      [webhook_type, webhook_code, user_id, successful_products, failed_products, item_ids, environment].hash
    end
