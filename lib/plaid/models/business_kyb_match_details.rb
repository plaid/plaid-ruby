...
module Plaid
  ...
  class BusinessKYBMatchDetails
    ...
    def self.openapi_types
      {
        :'names' => :'Array<ProviderBusinessName>',
        :'entity_type' => :'BusinessEntityType',
        :'addresses' => :'Array<ProviderBusinessAddress>',
        :'phone_numbers' => :'Array<BusinessPhoneNumber>',
        :'email_addresses' => :'Array<BusinessEmailAddress>',
        :'websites' => :'Array<BusinessWebsite>',
        :'formation_date' => :'Date'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::BusinessKYBMatchDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::BusinessKYBMatchDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @websites.nil?
        invalid_properties.push('invalid value for "websites", websites cannot be nil.')
      end
    ...
    def hash
      [names, entity_type, addresses, phone_numbers, email_addresses, websites, formation_date].hash
    end
