...
module Plaid
  ...
  class AddressMatchScore
    ...
    attr_accessor :is_postal_code_match
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::AddressMatchScore` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::AddressMatchScore`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_postal_code_match')
        self.is_postal_code_match = attributes[:'is_postal_code_match']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          score == o.score &&
          is_postal_code_match == o.is_postal_code_match
    end
    ...
    def hash
      [score, is_postal_code_match].hash
    end
