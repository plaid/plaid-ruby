...
module Plaid
  ...
  class PaymentStatusUpdateWebhook
    ...
    def hash
      [webhook_type, webhook_code, payment_id, new_payment_status, old_payment_status, original_reference, adjusted_reference, original_start_date, adjusted_start_date, timestamp, error, environment].hash
    end
