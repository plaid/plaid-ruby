  ...
  class ProtectIncidentEventResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::ProtectIncidentEventResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::ProtectIncidentEventResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'protect_event_id')
        self.protect_event_id = attributes[:'protect_event_id']
      end
      ...
      if attributes.key?(:'idv_session_id')
        self.idv_session_id = attributes[:'idv_session_id']
      end

      if attributes.key?(:'signal_client_transaction_id')
        self.signal_client_transaction_id = attributes[:'signal_client_transaction_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          protect_event_id == o.protect_event_id &&
          link_session_id == o.link_session_id &&
          idv_session_id == o.idv_session_id &&
          signal_client_transaction_id == o.signal_client_transaction_id &&
    ...
    def hash
      [protect_event_id, link_session_id, idv_session_id, signal_client_transaction_id, internal_reference, time, amount, item_id].hash
    end
