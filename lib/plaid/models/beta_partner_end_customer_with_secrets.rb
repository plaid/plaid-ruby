...
module Plaid
  ...
  class BetaPartnerEndCustomerWithSecrets
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::BetaPartnerEndCustomerWithSecrets` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::BetaPartnerEndCustomerWithSecrets`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'requirements_due')
        if (value = attributes[:'requirements_due']).is_a?(Array)
          self.requirements_due = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          requirements_due == o.requirements_due &&
          secrets == o.secrets
    end
    ...
    def hash
      [client_id, company_name, status, product_statuses, requirements_due, secrets].hash
    end
