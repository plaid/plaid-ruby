...
module Plaid
  ...
  class TransactionsSyncRequestOptions
    ...
    def hash
      [include_original_description, include_personal_finance_category, include_logo_and_counterparty_beta, personal_finance_category_version, days_requested, account_id].hash
    end
