...
module Plaid
  ...
  class AccountsBalanceGetRequestOptions
    ...
    attr_accessor :min_last_updated_datetime
    ...
    def self.openapi_types
      {
        ...
        :'min_last_updated_datetime' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::AccountsBalanceGetRequestOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::AccountsBalanceGetRequestOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'min_last_updated_datetime')
        self.min_last_updated_datetime = attributes[:'min_last_updated_datetime']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          min_last_updated_datetime == o.min_last_updated_datetime
    end
    ...
    def hash
      [account_ids, min_last_updated_datetime].hash
    end
