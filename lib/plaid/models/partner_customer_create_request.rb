...
module Plaid
  ...
  class PartnerCustomerCreateRequest
    ...
    def hash
      [client_id, secret, company_name, is_diligence_attested, products, create_link_customization, logo, legal_entity_name, website, application_name, technical_contact, billing_contact, address, is_bank_addendum_completed, assets_under_management].hash
    end
