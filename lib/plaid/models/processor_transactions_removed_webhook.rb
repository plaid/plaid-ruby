...
module Plaid
  ...
  class ProcessorTransactionsRemovedWebhook
    ...
    attr_accessor :removed_transactions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::ProcessorTransactionsRemovedWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::ProcessorTransactionsRemovedWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'removed_transactions')
        if (value = attributes[:'removed_transactions']).is_a?(Array)
          self.removed_transactions = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @removed_transactions.nil?
        invalid_properties.push('invalid value for "removed_transactions", removed_transactions cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error == o.error &&
          removed_transactions == o.removed_transactions &&
    ...
    def hash
      [webhook_type, webhook_code, error, removed_transactions, account_id, environment].hash
    end
