...
module Plaid
  ...
  class PhysicalDocumentExtractedData
    ...
    def list_invalid_properties
      ...
      if @id_number !~ pattern
        invalid_properties.push("invalid value for \"id_number\", must conform to the pattern #{pattern}.")
      end
      ...
      if @issuing_country !~ pattern
        invalid_properties.push("invalid value for \"issuing_country\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      return false if @id_number !~ Regexp.new(/^[A-Z0-9]+$/)
      return false if @category.nil?
      return false if @issuing_country.nil?
      return false if @issuing_country.to_s.length < 2
      return false if @issuing_country !~ Regexp.new(/^[A-Z]{2}$/)
      true
    end
    ...
    def id_number=(id_number)
      pattern = Regexp.new(/^[A-Z0-9]+$/)
      if id_number !~ pattern
        fail ArgumentError, "invalid value for \"id_number\", must conform to the pattern #{pattern}."
      end
    ...
    def issuing_country=(issuing_country)
      ...
      pattern = Regexp.new(/^[A-Z]{2}$/)
      if issuing_country !~ pattern
        fail ArgumentError, "invalid value for \"issuing_country\", must conform to the pattern #{pattern}."
      end
    ...
    def hash
      [id_number, category, expiration_date, issuing_country].hash
    end
