...
module Plaid
  ...
  class WalletTransaction
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["BANK_TRANSFER", "PAYOUT", "PIS_PAY_IN", "REFUND"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["BANK_TRANSFER", "PAYOUT", "PIS_PAY_IN", "REFUND"])
    ...
    def hash
      [transaction_id, reference, type, amount, counterparty, status, created_at, last_status_update, payment_id].hash
    end
