...
module Plaid
  ...
  class WalletTransaction
    ...
    attr_accessor :payee_verification_status
    ...
    def self.openapi_types
      {
        ...
        :'error' => :'PlaidError',
        :'related_transactions' => :'Array<WalletTransactionRelation>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'payee_verification_status')
        self.payee_verification_status = attributes[:'payee_verification_status']
      end
      ...
      if attributes.key?(:'related_transactions')
        if (value = attributes[:'related_transactions']).is_a?(Array)
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["BANK_TRANSFER", "PAYOUT", "PIS_PAY_IN", "REFUND", "FUNDS_SWEEP", "RETURN", "RECALL", "ACCOUNT_FUNDING", "AUTO_REFUND"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["BANK_TRANSFER", "PAYOUT", "PIS_PAY_IN", "REFUND", "FUNDS_SWEEP", "RETURN", "RECALL", "ACCOUNT_FUNDING", "AUTO_REFUND"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payee_verification_status == o.payee_verification_status &&
    ...
    def hash
      [transaction_id, wallet_id, reference, type, scheme, amount, counterparty, status, created_at, last_status_update, payee_verification_status, payment_id, failure_reason, error, related_transactions].hash
    end
