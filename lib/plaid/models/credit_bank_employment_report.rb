...
module Plaid
  ...
  class CreditBankEmploymentReport
    ...
    attr_accessor :bank_employment_report_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::CreditBankEmploymentReport` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::CreditBankEmploymentReport`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'bank_employment_report_id')
        self.bank_employment_report_id = attributes[:'bank_employment_report_id']
      end

      if attributes.key?(:'generated_time')
        self.generated_time = attributes[:'generated_time']
      end
    ...
    def list_invalid_properties
      ...
      if @bank_employment_report_id.nil?
        invalid_properties.push('invalid value for "bank_employment_report_id", bank_employment_report_id cannot be nil.')
      end

      if @generated_time.nil?
        invalid_properties.push('invalid value for "generated_time", generated_time cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          bank_employment_report_id == o.bank_employment_report_id &&
          generated_time == o.generated_time &&
    ...
    def hash
      [bank_employment_report_id, generated_time, days_requested, items, warnings].hash
    end
