...
module Plaid
  ...
  class FDXNotification
    ...
    attr_accessor :notification_payload
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::FDXNotification` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::FDXNotification`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'notification_payload')
        self.notification_payload = attributes[:'notification_payload']
      end
    ...
    def list_invalid_properties
      ...
      if @notification_payload.nil?
        invalid_properties.push('invalid value for "notification_payload", notification_payload cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          notification_payload == o.notification_payload &&
          url == o.url
    end
    ...
    def hash
      [notification_id, type, sent_on, category, severity, priority, publisher, subscriber, notification_payload, url].hash
    end
