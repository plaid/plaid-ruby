...
module Plaid
  ...
  class CreditBankIncomeSummary
    ...
    def hash
      [total_amount, iso_currency_code, unofficial_currency_code, total_amounts, start_date, end_date, income_sources_count, income_categories_count, income_transactions_count, historical_summary].hash
    end
