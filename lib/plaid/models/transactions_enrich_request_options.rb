...
module Plaid
  ...
  class TransactionsEnrichRequestOptions
    ...
    attr_accessor :include_legacy_category
    ...
    def self.attribute_map
      {
        :'include_legacy_category' => :'include_legacy_category',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::TransactionsEnrichRequestOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::TransactionsEnrichRequestOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'include_legacy_category')
        self.include_legacy_category = attributes[:'include_legacy_category']
      else
        self.include_legacy_category = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          include_legacy_category == o.include_legacy_category &&
    ...
    def hash
      [include_legacy_category, personal_finance_category_version].hash
    end
