  ...
  class SandboxTransferTestClockListRequest
    ...
    def self.openapi_types
      {
        :'client_id' => :'String',
        :'secret' => :'String',
        :'start_virtual_time' => :'Time',
        :'end_virtual_time' => :'Time',
        :'count' => :'Integer',
        :'offset' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::SandboxTransferTestClockListRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::SandboxTransferTestClockListRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'start_virtual_time')
        self.start_virtual_time = attributes[:'start_virtual_time']
      end

      if attributes.key?(:'end_virtual_time')
        self.end_virtual_time = attributes[:'end_virtual_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          secret == o.secret &&
          start_virtual_time == o.start_virtual_time &&
          end_virtual_time == o.end_virtual_time &&
          count == o.count &&
          offset == o.offset
    end
    ...
    def hash
      [client_id, secret, start_virtual_time, end_virtual_time, count, offset].hash
    end
