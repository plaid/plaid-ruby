...
module Plaid
  ...
  class BaseReportTransaction
    ...
    def hash
      [account_id, amount, iso_currency_code, unofficial_currency_code, name, original_description, credit_category, check_number, date, date_transacted, location, merchant_name, pending, account_owner, transaction_id, transaction_type, category, category_id].hash
    end
