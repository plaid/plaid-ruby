...
module Plaid
  ...
  class NumbersACHNullable
    ...
    attr_accessor :is_tokenized_account_number
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'is_tokenized_account_number')
        self.is_tokenized_account_number = attributes[:'is_tokenized_account_number']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account == o.account &&
          is_tokenized_account_number == o.is_tokenized_account_number &&
          routing == o.routing &&
    ...
    def hash
      [account_id, account, is_tokenized_account_number, routing, wire_routing, can_transfer_in, can_transfer_out].hash
    end
