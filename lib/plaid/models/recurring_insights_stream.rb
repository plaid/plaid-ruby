...
module Plaid
  ...
  class RecurringInsightsStream
    ...
    attr_accessor :average_days_apart
    ...
    def self.attribute_map
      {
        ...
        :'average_days_apart' => :'average_days_apart',
        :'frequency' => :'frequency',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::RecurringInsightsStream` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::RecurringInsightsStream`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'average_days_apart')
        self.average_days_apart = attributes[:'average_days_apart']
      end
    ...
    def list_invalid_properties
      ...
      if @average_days_apart.nil?
        invalid_properties.push('invalid value for "average_days_apart", average_days_apart cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          average_days_apart == o.average_days_apart &&
    ...
    def hash
      [stream_id, description, merchant_name, oldest_transaction_date, newest_transaction_date, average_days_apart, frequency, transaction_count, transaction_ids, average_amount, newest_transaction_amount, is_active, status, personal_finance_category_primary, personal_finance_category_detailed].hash
    end
