...
module Plaid
  ...
  class Enrichments
    ...
    def hash
      [merchant_name, website, logo_url, check_number, payment_channel, legacy_category_id, legacy_category, location, personal_finance_category, personal_finance_category_icon_url, counterparties].hash
    end
