...
module Plaid
  ...
  class Paystub
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'paystub_id')
        self.paystub_id = attributes[:'paystub_id']
      end
    ...
    def list_invalid_properties
      ...
      if @paystub_id.nil?
        invalid_properties.push('invalid value for "paystub_id", paystub_id cannot be nil.')
      end
      ...
      if @income_breakdown.nil?
        invalid_properties.push('invalid value for "income_breakdown", income_breakdown cannot be nil.')
      end

      if @ytd_earnings.nil?
        invalid_properties.push('invalid value for "ytd_earnings", ytd_earnings cannot be nil.')
      end
    ...
    def valid?
      return false if @paystub_id.nil?
      return false if @employer.nil?
      return false if @employee.nil?
      return false if @pay_period_details.nil?
      return false if @income_breakdown.nil?
      return false if @ytd_earnings.nil?
      true
    end
    ...
    def hash
      [paystub_id, account_id, employer, employee, pay_period_details, income_breakdown, ytd_earnings].hash
    end
