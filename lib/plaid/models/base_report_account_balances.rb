...
module Plaid
  ...
  class BaseReportAccountBalances
    ...
    attr_accessor :average_monthly_balances

    # The average historical balance from the most recent 30 days
    attr_accessor :most_recent_thirty_day_average_balance
    ...
    def self.attribute_map
      {
        ...
        :'average_monthly_balances' => :'average_monthly_balances',
        :'most_recent_thirty_day_average_balance' => :'most_recent_thirty_day_average_balance'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::BaseReportAccountBalances` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::BaseReportAccountBalances`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'average_monthly_balances')
        if (value = attributes[:'average_monthly_balances']).is_a?(Array)
          self.average_monthly_balances = value
        end
      end

      if attributes.key?(:'most_recent_thirty_day_average_balance')
        self.most_recent_thirty_day_average_balance = attributes[:'most_recent_thirty_day_average_balance']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          average_monthly_balances == o.average_monthly_balances &&
          most_recent_thirty_day_average_balance == o.most_recent_thirty_day_average_balance
    end
    ...
    def hash
      [available, current, limit, iso_currency_code, unofficial_currency_code, last_updated_datetime, average_balance, average_monthly_balances, most_recent_thirty_day_average_balance].hash
    end
