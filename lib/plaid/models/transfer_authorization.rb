...
module Plaid
  ...
  class TransferAuthorization
    ...
    def self.openapi_types
      {
        ...
        :'guarantee_details' => :'AuthorizationGuaranteeDetails',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'payment_risk')
        self.payment_risk = attributes[:'payment_risk']
      end
    ...
    def hash
      [id, created, decision, decision_rationale, guarantee_decision, guarantee_decision_rationale, guarantee_details, payment_risk, proposed_transfer].hash
    end
