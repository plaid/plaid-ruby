...
module Plaid
  ...
  class TransferAuthorization
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'signal_insights')
        self.signal_insights = attributes[:'signal_insights']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          signal_insights == o.signal_insights &&
    ...
    def hash
      [id, created, decision, decision_rationale, signal_insights, guarantee_decision, guarantee_decision_rationale, proposed_transfer].hash
    end
