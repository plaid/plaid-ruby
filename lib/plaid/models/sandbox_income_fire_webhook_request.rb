...
module Plaid
  ...
  class SandboxIncomeFireWebhookRequest
    ...
    def list_invalid_properties
      ...
      if @income_verification_id.nil?
        invalid_properties.push('invalid value for "income_verification_id", income_verification_id cannot be nil.')
      end
    ...
    def valid?
      ...
      verification_status_validator = EnumAttributeValidator.new('String', ["VERIFICATION_STATUS_PROCESSING_COMPLETE", "VERIFICATION_STATUS_DOCUMENT_REJECTED", "VERIFICATION_STATUS_PROCESSING_FAILED"])
    ...
    def verification_status=(verification_status)
      validator = EnumAttributeValidator.new('String', ["VERIFICATION_STATUS_PROCESSING_COMPLETE", "VERIFICATION_STATUS_DOCUMENT_REJECTED", "VERIFICATION_STATUS_PROCESSING_FAILED"])
    ...
    def hash
      [client_id, secret, income_verification_id, item_id, webhook, verification_status].hash
    end
