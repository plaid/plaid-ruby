...
module Plaid
  ...
  class DocumentRiskSignal
    ...
    attr_accessor :has_fraud_risk

    attr_accessor :institution_metadata
    ...
    attr_accessor :signal_description
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::DocumentRiskSignal` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::DocumentRiskSignal`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'has_fraud_risk')
        self.has_fraud_risk = attributes[:'has_fraud_risk']
      end

      if attributes.key?(:'institution_metadata')
        self.institution_metadata = attributes[:'institution_metadata']
      end
      ...
      if attributes.key?(:'signal_description')
        self.signal_description = attributes[:'signal_description']
      end
    ...
    def hash
      [type, field, has_fraud_risk, institution_metadata, expected_value, actual_value, signal_description, page_number].hash
    end
