...
module Plaid
  ...
  class TransferOriginatorDiligence
    ...
    attr_accessor :credit_usage_configuration
    ...
    # Custom attribute writer method with validation
    # @param [Object] naics_code Value to be assigned
    def naics_code=(naics_code)
      if naics_code.nil?
        fail ArgumentError, 'naics_code cannot be nil'
      end

      if naics_code.to_s.length > 6
        fail ArgumentError, 'invalid value for "naics_code", the character length must be smaller than or equal to 6.'
      end

      if naics_code.to_s.length < 6
        fail ArgumentError, 'invalid value for "naics_code", the character length must be great than or equal to 6.'
      end
    ...
    def hash
      [dba, tax_id, credit_usage_configuration, debit_usage_configuration, address, website, naics_code, funding_account].hash
    end
