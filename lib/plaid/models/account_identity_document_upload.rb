...
module Plaid
  ...
  class AccountIdentityDocumentUpload
    ...
    def hash
      [account_id, balances, mask, name, official_name, type, subtype, verification_status, verification_insights, persistent_account_id, holder_category, owners, documents].hash
    end
