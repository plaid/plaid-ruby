...
module Plaid
  ...
  class CashflowReportGetResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::CashflowReportGetResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::CashflowReportGetResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_successful_update_time')
    ...
    def list_invalid_properties
      ...
      if @last_successful_update_time.nil?
        invalid_properties.push('invalid value for "last_successful_update_time", last_successful_update_time cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @last_successful_update_time.nil?
    ...
    def hash
      [accounts, transactions, total_transactions, item, next_cursor, has_more, last_successful_update_time, request_id].hash
    end
