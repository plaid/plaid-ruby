...
module Plaid
  ...
  class PaymentInitiationPayment
    ...
    def hash
      [payment_id, amount, status, recipient_id, reference, adjusted_reference, last_status_update, schedule, refund_details, bacs, iban, refund_ids, amount_refunded, wallet_id, scheme, adjusted_scheme, consent_id, transaction_id, end_to_end_id, error].hash
    end
