...
module Plaid
  ...
  class Security
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'update_datetime')
      ...
      if attributes.key?(:'market_identifier_code')
        self.market_identifier_code = attributes[:'market_identifier_code']
      end
      ...
      if attributes.key?(:'option_contract')
        self.option_contract = attributes[:'option_contract']
      end

      if attributes.key?(:'fixed_income')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          market_identifier_code == o.market_identifier_code &&
          sector == o.sector &&
          industry == o.industry &&
          option_contract == o.option_contract &&
    ...
    def hash
      [security_id, isin, cusip, sedol, institution_security_id, institution_id, proxy_security_id, name, ticker_symbol, is_cash_equivalent, type, subtype, close_price, close_price_as_of, update_datetime, iso_currency_code, unofficial_currency_code, market_identifier_code, sector, industry, option_contract, fixed_income].hash
    end
