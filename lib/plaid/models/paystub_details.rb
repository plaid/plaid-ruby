...
module Plaid
  ...
  class PaystubDetails
    ...
    attr_accessor :paystub_provider
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::PaystubDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::PaystubDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'paystub_provider')
        self.paystub_provider = attributes[:'paystub_provider']
      end
    ...
    def valid?
      pay_frequency_validator = EnumAttributeValidator.new('String', ["MONTHLY", "BI-WEEKLY", "WEEKLY", "SEMI-MONTHLY"])
    ...
    def pay_frequency=(pay_frequency)
      validator = EnumAttributeValidator.new('String', ["MONTHLY", "BI-WEEKLY", "WEEKLY", "SEMI-MONTHLY"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pay_date == o.pay_date &&
          paystub_provider == o.paystub_provider &&
    ...
    def hash
      [pay_period_start_date, pay_period_end_date, pay_date, paystub_provider, pay_frequency].hash
    end
