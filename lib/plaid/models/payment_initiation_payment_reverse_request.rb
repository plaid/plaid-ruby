...
module Plaid
  ...
  class PaymentInitiationPaymentReverseRequest
    ...
    attr_accessor :counterparty_date_of_birth
    ...
    def self.openapi_types
      {
        ...
        :'counterparty_date_of_birth' => :'Date',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::PaymentInitiationPaymentReverseRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::PaymentInitiationPaymentReverseRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'counterparty_date_of_birth')
        self.counterparty_date_of_birth = attributes[:'counterparty_date_of_birth']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          counterparty_date_of_birth == o.counterparty_date_of_birth &&
    ...
    def hash
      [client_id, secret, payment_id, idempotency_key, reference, amount, counterparty_date_of_birth, counterparty_address].hash
    end
