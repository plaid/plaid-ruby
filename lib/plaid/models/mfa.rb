  ...
  class MFA
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::MFA` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::MFA`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'question_rounds')
        self.question_rounds = attributes[:'question_rounds']
      end

      if attributes.key?(:'questions_per_round')
        self.questions_per_round = attributes[:'questions_per_round']
      end

      if attributes.key?(:'selection_rounds')
        self.selection_rounds = attributes[:'selection_rounds']
      end

      if attributes.key?(:'selections_per_question')
        self.selections_per_question = attributes[:'selections_per_question']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          question_rounds == o.question_rounds &&
          questions_per_round == o.questions_per_round &&
          selection_rounds == o.selection_rounds &&
          selections_per_question == o.selections_per_question
    end
