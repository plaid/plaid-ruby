...
module Plaid
  ...
  class LinkTokenCreateRequestCraOptions
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'income_insights')
        self.income_insights = attributes[:'income_insights']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          income_insights == o.income_insights
    end
    ...
    def hash
      [days_requested, days_required, client_report_id, partner_insights, base_report, cashflow_insights, lend_score, network_insights, include_investments, income_insights].hash
    end
