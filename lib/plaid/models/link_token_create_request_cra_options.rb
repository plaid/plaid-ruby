...
module Plaid
  ...
  class LinkTokenCreateRequestCraOptions
    ...
    attr_accessor :cashflow_insights

    attr_accessor :plaid_credit_score

    # Indicates that investment data should be extracted from the linked account(s).
    attr_accessor :include_investments
    ...
    def self.attribute_map
      {
        ...
        :'plaid_credit_score' => :'plaid_credit_score',
    ...
    def self.openapi_types
      {
        ...
        :'plaid_credit_score' => :'LinkTokenCreateRequestCraOptionsPlaidCreditScore',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::LinkTokenCreateRequestCraOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::LinkTokenCreateRequestCraOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'plaid_credit_score')
        self.plaid_credit_score = attributes[:'plaid_credit_score']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] days_required Value to be assigned
    def days_required=(days_required)
      if !days_required.nil? && days_required > 184
        fail ArgumentError, 'invalid value for "days_required", must be smaller than or equal to 184.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          plaid_credit_score == o.plaid_credit_score &&
    ...
    def hash
      [days_requested, days_required, client_report_id, partner_insights, base_report, cashflow_insights, plaid_credit_score, include_investments].hash
    end
