...
module Plaid
  ...
  class LinkTokenCreateRequestCraOptions
    ...
    def list_invalid_properties
      ...
      if !@days_required.nil? && @days_required > 730
        invalid_properties.push('invalid value for "days_required", must be smaller than or equal to 730.')
      end
    ...
    def valid?
      ...
      return false if !@days_required.nil? && @days_required > 730
      true
    end
    ...
    def days_required=(days_required)
      if !days_required.nil? && days_required > 730
        fail ArgumentError, 'invalid value for "days_required", must be smaller than or equal to 730.'
      end
    ...
    def hash
      [days_requested, days_required, client_report_id, partner_insights, base_report, cashflow_insights].hash
    end
