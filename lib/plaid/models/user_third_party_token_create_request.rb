...
module Plaid
  ...
  class UserThirdPartyTokenCreateRequest
    ...
    attr_accessor :third_party_client_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::UserThirdPartyTokenCreateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::UserThirdPartyTokenCreateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'third_party_client_id')
        self.third_party_client_id = attributes[:'third_party_client_id']
      end
    ...
    def list_invalid_properties
      ...
      if @third_party_client_id.nil?
        invalid_properties.push('invalid value for "third_party_client_id", third_party_client_id cannot be nil.')
      end
    ...
    def valid?
      return false if @third_party_client_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_id == o.user_id &&
          third_party_client_id == o.third_party_client_id &&
    ...
    def hash
      [client_id, secret, user_token, user_id, third_party_client_id, expiration_time].hash
    end
