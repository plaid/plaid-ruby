...
module Plaid
  ...
  class WalletTransactionExecuteRequest
    ...
    attr_accessor :originating_fund_source
    ...
    def self.attribute_map
      {
        ...
        :'amount' => :'amount',
        :'reference' => :'reference',
        :'originating_fund_source' => :'originating_fund_source'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'originating_fund_source')
        self.originating_fund_source = attributes[:'originating_fund_source']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          originating_fund_source == o.originating_fund_source
    end
    ...
    def hash
      [client_id, secret, idempotency_key, wallet_id, counterparty, amount, reference, originating_fund_source].hash
    end
