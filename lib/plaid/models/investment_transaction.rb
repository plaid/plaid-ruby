...
module Plaid
  ...
  class InvestmentTransaction
    ...
    attr_accessor :transaction_datetime
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'transaction_datetime')
        self.transaction_datetime = attributes[:'transaction_datetime']
      end
    ...
    def hash
      [investment_transaction_id, cancel_transaction_id, account_id, security_id, date, transaction_datetime, name, quantity, amount, price, fees, type, subtype, iso_currency_code, unofficial_currency_code].hash
    end
