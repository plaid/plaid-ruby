...
module Plaid
  ...
  class ItemWithConsentFields
    ...
    def hash
      [item_id, institution_id, webhook, error, available_products, billed_products, products, consented_products, consent_expiration_time, update_type, created_at, consented_use_cases, consented_data_scopes].hash
    end
