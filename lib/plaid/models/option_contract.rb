...
module Plaid
  ...
  class OptionContract
    ...
    attr_accessor :underlying_security_ticker
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::OptionContract` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::OptionContract`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'underlying_security_ticker')
        self.underlying_security_ticker = attributes[:'underlying_security_ticker']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @underlying_security_ticker.nil?
        invalid_properties.push('invalid value for "underlying_security_ticker", underlying_security_ticker cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @underlying_security_ticker.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          underlying_security_ticker == o.underlying_security_ticker
    end
    ...
    def hash
      [contract_type, expiration_date, strike_price, underlying_security_ticker].hash
    end
