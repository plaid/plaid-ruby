...
module Plaid
  ...
  class HoldingsDefaultUpdateWebhook
    ...
    attr_accessor :new_holdings

    # The number of updated holdings reported since the last time this webhook was fired.
    attr_accessor :updated_holdings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::HoldingsDefaultUpdateWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::HoldingsDefaultUpdateWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'new_holdings')
        self.new_holdings = attributes[:'new_holdings']
      end

      if attributes.key?(:'updated_holdings')
        self.updated_holdings = attributes[:'updated_holdings']
      end
    ...
    def list_invalid_properties
      ...
      if @new_holdings.nil?
        invalid_properties.push('invalid value for "new_holdings", new_holdings cannot be nil.')
      end

      if @updated_holdings.nil?
        invalid_properties.push('invalid value for "updated_holdings", updated_holdings cannot be nil.')
      end
    ...
    def hash
      [webhook_type, webhook_code, item_id, error, new_holdings, updated_holdings, environment].hash
    end
