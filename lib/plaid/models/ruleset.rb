...
module Plaid
  ...
  class Ruleset
    ...
    attr_accessor :triggered_rule_details
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::Ruleset` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::Ruleset`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'triggered_rule_details')
        self.triggered_rule_details = attributes[:'triggered_rule_details']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          result == o.result &&
          triggered_rule_details == o.triggered_rule_details &&
          outcome == o.outcome
    end
    ...
    def hash
      [ruleset_key, result, triggered_rule_details, outcome].hash
    end
