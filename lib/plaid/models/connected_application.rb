...
module Plaid
  ...
  class ConnectedApplication
    ...
    attr_accessor :product_data_types
    ...
    def self.openapi_types
      {
        ...
        :'created_at' => :'Date',
        :'join_date' => :'Date',
        :'product_data_types' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::ConnectedApplication` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::ConnectedApplication`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'product_data_types')
        if (value = attributes[:'product_data_types']).is_a?(Array)
          self.product_data_types = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @product_data_types.nil?
        invalid_properties.push('invalid value for "product_data_types", product_data_types cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @product_data_types.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          product_data_types == o.product_data_types &&
          scopes == o.scopes &&
    ...
    def hash
      [application_id, name, logo, logo_url, application_url, reason_for_access, created_at, join_date, product_data_types, scopes, requested_scopes, status].hash
    end
