...
module Plaid
  ...
  class ProcessorInvestmentsAuthGetResponse
    ...
    attr_accessor :account_details_401k
    ...
    def self.attribute_map
      {
        ...
        :'account_details_401k' => :'account_details_401k',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::ProcessorInvestmentsAuthGetResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::ProcessorInvestmentsAuthGetResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_sources')
        self.data_sources = attributes[:'data_sources']
      end

      if attributes.key?(:'account_details_401k')
        if (value = attributes[:'account_details_401k']).is_a?(Array)
          self.account_details_401k = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_details_401k == o.account_details_401k &&
    ...
    def hash
      [account, holdings, securities, owners, numbers, data_sources, account_details_401k, is_investments_fallback_item, request_id].hash
    end
