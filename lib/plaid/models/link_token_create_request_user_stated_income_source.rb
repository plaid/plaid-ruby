  ...
  class LinkTokenCreateRequestUserStatedIncomeSource
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::LinkTokenCreateRequestUserStatedIncomeSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::LinkTokenCreateRequestUserStatedIncomeSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pay_per_cycle')
        self.pay_per_cycle = attributes[:'pay_per_cycle']
      end

      if attributes.key?(:'pay_annual')
        self.pay_annual = attributes[:'pay_annual']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          employer == o.employer &&
          category == o.category &&
          pay_per_cycle == o.pay_per_cycle &&
          pay_annual == o.pay_annual &&
          pay_type == o.pay_type &&
    ...
    def hash
      [employer, category, pay_per_cycle, pay_annual, pay_type, pay_frequency].hash
    end
