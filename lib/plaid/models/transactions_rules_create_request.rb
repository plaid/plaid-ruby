...
module Plaid
  ...
  class TransactionsRulesCreateRequest
    ...
    def list_invalid_properties
      ...
      if @personal_finance_category.nil?
        invalid_properties.push('invalid value for "personal_finance_category", personal_finance_category cannot be nil.')
      end
    ...
    def hash
      [client_id, access_token, secret, personal_finance_category, rule_details].hash
    end
