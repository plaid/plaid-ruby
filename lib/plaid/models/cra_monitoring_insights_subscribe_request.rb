...
module Plaid
  ...
  class CraMonitoringInsightsSubscribeRequest
    ...
    attr_accessor :income_categories
    ...
    def self.openapi_types
      {
        ...
        :'item_id' => :'String',
        :'webhook' => :'String',
        :'income_categories' => :'Array<CreditBankIncomeCategory>',
        :'user_token' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::CraMonitoringInsightsSubscribeRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::CraMonitoringInsightsSubscribeRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'income_categories')
        if (value = attributes[:'income_categories']).is_a?(Array)
          self.income_categories = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item_id == o.item_id &&
          webhook == o.webhook &&
          income_categories == o.income_categories &&
    ...
    def hash
      [client_id, secret, user_id, item_id, webhook, income_categories, user_token].hash
    end
