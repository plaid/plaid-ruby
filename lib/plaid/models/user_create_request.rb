...
module Plaid
  ...
  class UserCreateRequest
    ...
    attr_accessor :consumer_report_user_identity
    ...
    attr_accessor :with_upgraded_user
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::UserCreateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::UserCreateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'consumer_report_user_identity')
        self.consumer_report_user_identity = attributes[:'consumer_report_user_identity']
      end

      if attributes.key?(:'with_upgraded_user')
        self.with_upgraded_user = attributes[:'with_upgraded_user']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @client_user_id.to_s.length > 128
        invalid_properties.push('invalid value for "client_user_id", the character length must be smaller than or equal to 128.')
      end
      ...
      if !@end_customer.nil? && @end_customer.to_s.length > 128
        invalid_properties.push('invalid value for "end_customer", the character length must be smaller than or equal to 128.')
      end

      if !@end_customer.nil? && @end_customer.to_s.length < 0
        invalid_properties.push('invalid value for "end_customer", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @client_user_id.to_s.length > 128
      return false if @client_user_id.to_s.length < 1
      return false if !@end_customer.nil? && @end_customer.to_s.length > 128
      return false if !@end_customer.nil? && @end_customer.to_s.length < 0
      true
    end
    ...
    def client_user_id=(client_user_id)
      ...
      if client_user_id.to_s.length > 128
        fail ArgumentError, 'invalid value for "client_user_id", the character length must be smaller than or equal to 128.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] end_customer Value to be assigned
    def end_customer=(end_customer)
      if !end_customer.nil? && end_customer.to_s.length > 128
        fail ArgumentError, 'invalid value for "end_customer", the character length must be smaller than or equal to 128.'
      end

      if !end_customer.nil? && end_customer.to_s.length < 0
        fail ArgumentError, 'invalid value for "end_customer", the character length must be great than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          with_upgraded_user == o.with_upgraded_user
    end
    ...
    def hash
      [client_id, secret, client_user_id, identity, end_customer, consumer_report_user_identity, with_upgraded_user].hash
    end
