...
module Plaid
  ...
  class BaseReportAccountInsights
    ...
    attr_accessor :longest_gaps_between_transactions
    ...
    attr_accessor :average_inflow_amounts
    ...
    attr_accessor :average_outflow_amounts
    ...
    def self.openapi_types
      {
        ...
        :'longest_gaps_between_transactions' => :'Array<BaseReportLongestGapInsights>',
        :'number_of_inflows' => :'Array<BaseReportNumberFlowInsights>',
        :'average_inflow_amounts' => :'Array<BaseReportAverageFlowInsights>',
        :'number_of_outflows' => :'Array<BaseReportNumberFlowInsights>',
        :'average_outflow_amounts' => :'Array<BaseReportAverageFlowInsights>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'longest_gaps_between_transactions')
        if (value = attributes[:'longest_gaps_between_transactions']).is_a?(Array)
          self.longest_gaps_between_transactions = value
        end
      end
      ...
      if attributes.key?(:'average_inflow_amounts')
        if (value = attributes[:'average_inflow_amounts']).is_a?(Array)
          self.average_inflow_amounts = value
        end
      end
      ...
      if attributes.key?(:'average_outflow_amounts')
        if (value = attributes[:'average_outflow_amounts']).is_a?(Array)
          self.average_outflow_amounts = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          longest_gaps_between_transactions == o.longest_gaps_between_transactions &&
          number_of_inflows == o.number_of_inflows &&
          average_inflow_amounts == o.average_inflow_amounts &&
          number_of_outflows == o.number_of_outflows &&
          average_outflow_amounts == o.average_outflow_amounts &&
    ...
    def hash
      [oldest_transaction_date, most_recent_transaction_date, days_available, average_days_between_transactions, longest_gaps_between_transactions, number_of_inflows, average_inflow_amounts, number_of_outflows, average_outflow_amounts, number_of_days_no_transactions].hash
    end
