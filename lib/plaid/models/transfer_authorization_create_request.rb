...
module Plaid
  ...
  class TransferAuthorizationCreateRequest
    ...
    def hash
      [client_id, secret, access_token, account_id, type, network, amount, ach_class, user, device, origination_account_id, iso_currency_code, user_present, payment_profile_id].hash
    end
