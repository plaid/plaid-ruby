...
module Plaid
  ...
  class TransferAuthorizationCreateRequest
    ...
    attr_accessor :request_guarantee
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'request_guarantee')
        self.request_guarantee = attributes[:'request_guarantee']
      end
    ...
    def valid?
      ...
      return false if !@custom_attributes.nil? && @custom_attributes.length > 50
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          request_guarantee == o.request_guarantee &&
