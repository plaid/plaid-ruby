...
module Plaid
  ...
  class TransferAuthorizationCreateRequest
    ...
    def hash
      [client_id, secret, access_token, account_id, payment_profile_token, type, network, amount, ach_class, user, device, origination_account_id, iso_currency_code, idempotency_key, user_present, with_guarantee, beacon_session_id].hash
    end
