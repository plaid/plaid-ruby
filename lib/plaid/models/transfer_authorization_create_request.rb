...
module Plaid
  ...
  class TransferAuthorizationCreateRequest
    ...
    def hash
      [client_id, secret, access_token, idempotency_key, account_id, type, network, amount, ach_class, user, device, origination_account_id, iso_currency_code, user_present, with_guarantee, payment_profile_id].hash
    end
