  ...
  class CraBankIncomeSummary
    ...
    def self.openapi_types
      {
        ...
        :'forcasted_average_monthly_income' => :'Array<CreditAmountWithCurrency>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'forcasted_average_monthly_income')
        if (value = attributes[:'forcasted_average_monthly_income']).is_a?(Array)
          self.forcasted_average_monthly_income = value
        end
      end
    ...
    def hash
      [total_amounts, start_date, end_date, income_sources_count, income_categories_count, income_transactions_count, historical_average_monthly_gross_income, historical_average_monthly_income, forcasted_average_monthly_income, historical_summary].hash
    end
