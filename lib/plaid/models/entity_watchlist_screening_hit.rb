...
module Plaid
  ...
  class EntityWatchlistScreeningHit
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'sub_programs')
        if (value = attributes[:'sub_programs']).is_a?(Array)
          self.sub_programs = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @sub_programs.nil?
        invalid_properties.push('invalid value for "sub_programs", sub_programs cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sub_programs.nil?
      true
    end
    ...
    def hash
      [id, review_status, first_active, inactive_since, historical_since, list_code, plaid_uid, source_uid, sub_programs, analysis, data].hash
    end
