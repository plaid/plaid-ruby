...
module Plaid
  ...
  class EntityWatchlistScreeningHit
    ...
    attr_accessor :entity_list_code
    ...
    def self.attribute_map
      {
        ...
        :'entity_list_code' => :'entity_list_code',
        :'plaid_uid' => :'plaid_uid',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::EntityWatchlistScreeningHit` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::EntityWatchlistScreeningHit`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'entity_list_code')
        self.entity_list_code = attributes[:'entity_list_code']
      end
    ...
    def list_invalid_properties
      ...
      if @entity_list_code.nil?
        invalid_properties.push('invalid value for "entity_list_code", entity_list_code cannot be nil.')
      end
      ...
      if @source_uid.to_s.length < 1
        invalid_properties.push('invalid value for "source_uid", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @entity_list_code.nil?
      return false if @plaid_uid.nil?
      return false if @source_uid.to_s.length < 1
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] source_uid Value to be assigned
    def source_uid=(source_uid)
      if source_uid.to_s.length < 1
        fail ArgumentError, 'invalid value for "source_uid", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          entity_list_code == o.entity_list_code &&
    ...
    def hash
      [id, review_status, first_active, inactive_since, historical_since, entity_list_code, plaid_uid, source_uid, analysis, data].hash
    end
