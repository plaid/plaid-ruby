...
module Plaid
  ...
  class TransactionsGetRequestOptions
    ...
    def hash
      [account_ids, count, offset, include_original_description, include_personal_finance_category_beta, include_personal_finance_category, include_logo_and_counterparty_beta, personal_finance_category_version, days_requested].hash
    end
