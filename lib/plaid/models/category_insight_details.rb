...
module Plaid
  ...
  class CategoryInsightDetails
    ...
    attr_accessor :top_counterparties
    ...
    def self.openapi_types
      {
        ...
        :'total_inflows' => :'Float',
        :'top_counterparties' => :'Array<Counterparty>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::CategoryInsightDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::CategoryInsightDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'top_counterparties')
        if (value = attributes[:'top_counterparties']).is_a?(Array)
          self.top_counterparties = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @top_counterparties.nil?
        invalid_properties.push('invalid value for "top_counterparties", top_counterparties cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @top_counterparties.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          top_counterparties == o.top_counterparties
    end
    ...
    def hash
      [name, transaction_count, total_outflows, total_inflows, top_counterparties].hash
    end
