...
module Plaid
  ...
  class CraVerificationReport
    ...
    attr_accessor :gse_reference_id
    ...
    attr_accessor :employment_refresh
    ...
    def self.openapi_types
      {
        ...
        :'income' => :'CraVerificationIncomeReport'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::CraVerificationReport` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::CraVerificationReport`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gse_reference_id')
        self.gse_reference_id = attributes[:'gse_reference_id']
      end
      ...
      if attributes.key?(:'employment_refresh')
        self.employment_refresh = attributes[:'employment_refresh']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gse_reference_id == o.gse_reference_id &&
          client_report_id == o.client_report_id &&
          voa == o.voa &&
          employment_refresh == o.employment_refresh &&
          income == o.income
    end
    ...
    def hash
      [report_id, gse_reference_id, client_report_id, voa, employment_refresh, income].hash
    end
