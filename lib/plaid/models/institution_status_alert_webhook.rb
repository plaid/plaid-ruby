...
module Plaid
  ...
  class InstitutionStatusAlertWebhook
    ...
    attr_accessor :institution_overall_success_rate
    ...
    def self.openapi_types
      {
        ...
        :'institution_overall_success_rate' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::InstitutionStatusAlertWebhook` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::InstitutionStatusAlertWebhook`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'institution_overall_success_rate')
        self.institution_overall_success_rate = attributes[:'institution_overall_success_rate']
      end
    ...
    def list_invalid_properties
      ...
      if @institution_overall_success_rate.nil?
        invalid_properties.push('invalid value for "institution_overall_success_rate", institution_overall_success_rate cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          institution_overall_success_rate == o.institution_overall_success_rate &&
    ...
    def hash
      [webhook_type, webhook_code, institution_id, institution_overall_success_rate, environment].hash
    end
