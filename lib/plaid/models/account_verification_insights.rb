...
module Plaid
  ...
  class AccountVerificationInsights
    ...
    attr_accessor :name_match_score
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::AccountVerificationInsights` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::AccountVerificationInsights`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'name_match_score')
        self.name_match_score = attributes[:'name_match_score']
      end
      ...
      if attributes.key?(:'previous_returns')
        self.previous_returns = attributes[:'previous_returns']
      end

      if attributes.key?(:'account_number_format')
    ...
    def list_invalid_properties
      ...
      if @network_status.nil?
        invalid_properties.push('invalid value for "network_status", network_status cannot be nil.')
      end

      if @account_number_format.nil?
        invalid_properties.push('invalid value for "account_number_format", account_number_format cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @account_number_format.nil?
      true
    end
    ...
    def hash
      [name_match_score, network_status, previous_returns, account_number_format].hash
    end
