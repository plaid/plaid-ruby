...
module Plaid
  ...
  class SandboxCraCashflowUpdatesUpdateRequest
    ...
    def self.openapi_types
      {
        ...
        :'secret' => :'String',
        :'user_token' => :'String',
        :'webhook_codes' => :'Array<CashFlowUpdatesEventWebhookCodes>',
        :'user_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::SandboxCraCashflowUpdatesUpdateRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::SandboxCraCashflowUpdatesUpdateRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'webhook_codes')
    ...
    def hash
      [client_id, secret, user_token, webhook_codes, user_id].hash
    end
