...
module Plaid
  ...
  class Transfer
    ...
    def hash
      [id, ach_class, account_id, type, user, amount, description, created, status, sweep_status, network, cancellable, failure_reason, metadata, origination_account_id, iso_currency_code].hash
    end
