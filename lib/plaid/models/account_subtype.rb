...
module Plaid
  class AccountSubtype
    ...
    LIMITED_PURPOSE_CHECKING = "limited purpose checking".freeze
    ...
    ROTH_403_B = "roth 403B".freeze
    ROTH_457B = "roth 457b".freeze
    ROTH_PENSION = "roth pension".freeze
    ROTH_PROFIT_SHARING_PLAN = "roth profit sharing plan".freeze
    ROTH_THRIFT_SAVINGS_PLAN = "roth thrift savings plan".freeze
    RRIF = "rrif".freeze
    RRSP = "rrsp".freeze
