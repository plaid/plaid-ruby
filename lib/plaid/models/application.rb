...
module Plaid
  ...
  class Application
    ...
    def hash
      [application_id, name, created_at, join_date, logo_url, application_url, reason_for_access, use_case, company_legal_name, city, region, postal_code, country_code].hash
    end
