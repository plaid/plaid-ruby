  ...
  class IncomeInsightsFilter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::IncomeInsightsFilter` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::IncomeInsightsFilter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'included_categories')
        if (value = attributes[:'included_categories']).is_a?(Array)
          self.included_categories = value
        end
      end

      if attributes.key?(:'excluded_categories')
        if (value = attributes[:'excluded_categories']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @included_categories.nil?
        invalid_properties.push('invalid value for "included_categories", included_categories cannot be nil.')
      end
    ...
    def valid?
      return false if @included_categories.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          included_categories == o.included_categories &&
    ...
    def hash
      [included_categories, excluded_categories].hash
    end
