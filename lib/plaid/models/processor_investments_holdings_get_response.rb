...
module Plaid
  ...
  class ProcessorInvestmentsHoldingsGetResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::ProcessorInvestmentsHoldingsGetResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::ProcessorInvestmentsHoldingsGetResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @is_investments_fallback_item.nil?
        invalid_properties.push('invalid value for "is_investments_fallback_item", is_investments_fallback_item cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @is_investments_fallback_item.nil?
      true
    end
    ...
    def hash
      [account, holdings, securities, is_investments_fallback_item, request_id].hash
    end
