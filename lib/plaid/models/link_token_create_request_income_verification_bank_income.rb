...
module Plaid
  ...
  class LinkTokenCreateRequestIncomeVerificationBankIncome
    ...
    attr_accessor :enable_multiple_items
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Plaid::LinkTokenCreateRequestIncomeVerificationBankIncome` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Plaid::LinkTokenCreateRequestIncomeVerificationBankIncome`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enable_multiple_items')
        self.enable_multiple_items = attributes[:'enable_multiple_items']
      else
        self.enable_multiple_items = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enable_multiple_items == o.enable_multiple_items
    end
    ...
    def hash
      [days_requested, enable_multiple_items].hash
    end
