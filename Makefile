...
OPENAPI_GENERATOR_5:=docker run --rm -v $(CURRENT_DIR):/local openapitools/openapi-generator-cli:v5.0.0 generateOPENAPI_VERSION:=1.5.0-beta
# Ruby embeds the version in the generator where as others dont os its not possible to cat for it.
RUBY_PACKAGE_VERSION="14.0.0.beta.1"
