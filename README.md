...
# Passing bacs as nil
create_recipient_response = client.payment_initiation.create_recipient(name, iban, address, nil)
...
# For UK recipients, only bacs is required. iban and address are nil
create_recipient_response = client.payment_initiation.create_recipient(name, nil, nil, bacs)
recipient_id = create_recipient_response.recipient_id
```
